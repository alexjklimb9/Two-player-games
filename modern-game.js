...
const C={bg:'#0b0f14',bg2:'#141a22',line:'rgba(235,240,245,.08)',line2:'rgba(235,240,245,.16)',top:'#9fb8c4',bottom:'#c49aa5',topInk:'#263944',bottomInk:'#4a333b',board:'#d7dde5',boardDark:'#2b333d',danger:'#c7775d',white:'#f8fafc',muted:'#94a3b8',haz:['#d4d4d8','#a8a29e','#cbd5e1','#b8b0a8']};
...
function drawButton(x,y,w,h,label,on,color){ctx.fillStyle=on?color:'rgba(17,24,39,.78)';ctx.strokeStyle=on?'rgba(255,255,255,.35)':'rgba(255,255,255,.14)';ctx.lineWidth=1.5;rr(x,y,w,h,18,true,true);ctx.fillStyle=on?'#0b0f14':C.white;ctx.font='800 28px Arial';ctx.textAlign='center';ctx.textBaseline='middle';ctx.fillText(label,x+w/2,y+h/2+1)}
